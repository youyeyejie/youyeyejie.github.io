---
title: 论文阅读与复现：MIA against DLMs
tags:
  - 人工智能安全
  - MIA
categories:
...
### 方法概览
![](论文阅读与复现：MIA-against-DLMs/image.webp)
...
### 算法说明
![](论文阅读与复现：MIA-against-DLMs/image-1.webp)
...
2. **基于符号的子集聚合是关键**：在**消融实验**（Ablation Study）中，逐步移除 SAMA 的核心组件，评估其对性能的贡献：
    ![](论文阅读与复现：MIA-against-DLMs/image-4.webp)
