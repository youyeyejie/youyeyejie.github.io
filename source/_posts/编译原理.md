...
> 本笔记基于上海交通大学*胡易坤教授* 2024-2025 学年春季学期教学内容进行整理，部分图片来自胡教授的PPT，若有侵权请联系删除。
...
## 编译流程
![alt text](编译原理/image-1.png)
- 解释器 vs. 编译器 (Interpreter vs. Compiler)
    - 解释器方便错误诊断 (Error Diagnosis)
    - 编译器得到的代码更加高效
    ![alt text](编译原理/image-2.png)
### 编译器
![alt text](编译原理/image.png)
...
- **Example**: ![yyyj](编译原理/image-51.png)
...
- **Transition Tables**：**rows** for States, **columns** for Input Symbols and 𝝐
    - Example: ![yyyj](编译原理/image-10.png)
...
- **Algorithm 𝜖-closure(T) Computation**:
    ...
    ```
- **Example**: ![yyyj](编译原理/image-11.png)

### Conversion: Regex --> NFA
- McNaughton-Yamada-Thompson Algorithm
- Regex's Definition:
    - **BASIS**:
        ![yyyj](编译原理/image-12.png)
    - **INDUCTION**:
        ![yyyj](编译原理/image-13.png)
- **Example**:
    ![yyyj](编译原理/image-14.png)
...
- **Example**:![yyyj](编译原理/image-15.png)
...
- **Predictive Parsing Table Construction**
    ...
    - **Example**:
        ![yyyj](编译原理/image-24.png)
        ![yyyj](编译原理/image-25.png)

- **Implementation**
    - Stack-based Method, mimicking a leftmost derivation （基于栈的方法，模仿最左派生）

    ![yyyj](编译原理/image-26.png)
...
- **Example**:
    ![yyyj](编译原理/image-30.png)
    ![yyyj](编译原理/image-31.png)
...
- **LR(0) Parsing Table $\mathbb{T}$**:
    ...
    - ![yyyj](编译原理/image-37.png)

- **Example**:
    ![yyyj](编译原理/image-38.png)
...
- **Example**:
    1. **Example**:
        ![yyyj](编译原理/image-42.png)
    2. **Exercise**:
        ![yyyj](编译原理/image-44.png)
...
- Example:
    ![yyyj](编译原理/image-49.png)

## Summary
![yyyj](编译原理/image-50.png)