...
## 课程仓库
<a href="https://github.com/youyeyejie/NIS3355_Simple_Paxos" target="_blank" logourl="https://github.githubassets.com/assets/apple-touch-icon-144x144-b882e354c005.png" class="LinkCard">Github-NIS3355 Simple Paxos</a>
...
## 实验目标
了解共识的运行过程，并在课程仓库中给定的 SimplePaxos 框架下动手实现 Paxos 共识协议的核心逻辑，通过协议的运行保证所有参与节点以相同的顺序对所有的请求进行提交。
